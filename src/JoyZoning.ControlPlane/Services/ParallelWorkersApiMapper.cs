...
internal static class ParallelWorkersApiMapper
{
    ...
    public static object MapWorker(ParallelWorkerEntry w) => new
    {
        ...
        taskExecutionMode = w.TaskExecutionMode?.ToString(),
        executionDriver = w.ExecutionDriver?.ToString(),
        externalAgentName = w.ExternalAgentName,
        branchName = w.BranchName,
        lastWorkspaceScanAt = w.LastWorkspaceScanAt,
        changedFiles = w.ChangedFiles,
        generatedPrompt = w.GeneratedPrompt,
