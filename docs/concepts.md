...
This page is the conceptual spine. Implementation details live in [architecture.md](architecture.md), [lease-lifecycle.md](lease-lifecycle.md), and [hermes-integration.md](hermes-integration.md).
